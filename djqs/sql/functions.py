...
from djqs.utils import get_issue_url

if TYPE_CHECKING:
    from djqs.sql.lib import Wildcard
...
class DateTruncNotImplementException(DJNotImplementedException):
    ...
    def __init__(self, dialect: str, resolution: str):
        ...
        docs_url = (
            "https://github.com/DataJunction/djqs/blob/main/docs/functions.rst"
            "#date_trunc"
        )
        super().__init__(
...
class FunctionRegistry:  # pylint: disable=too-few-public-methods
    ...
    def __getitem__(self, name: str) -> Type[Function]:
        ...
        docs_url = "https://github.com/DataJunction/djqs/blob/main/docs/functions.rst"
