...
def _check_col(
    ...
    """
    namespace = make_name(col.table.namespace, col.table.name.name) if isinstance(col.table, ast.Named) else make_name(col.namespace)  # str preceding the column name
