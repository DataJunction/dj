...
request_body_engine_info = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = CatalogInfo
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_engines_to_catalog_catalogs_name_engines_post_oapg(
        self,
    ...
    def _add_engines_to_catalog_catalogs_name_engines_post_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_engine_info.serialize(body, content_type)
...
class AddEnginesToCatalogCatalogsNameEnginesPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_engines_to_catalog_catalogs_name_engines_post(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def add_engines_to_catalog_catalogs_name_engines_post(
        ...
        return self._add_engines_to_catalog_catalogs_name_engines_post_oapg(
            body=body,
