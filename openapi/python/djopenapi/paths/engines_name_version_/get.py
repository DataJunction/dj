...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_engine_engines_name_version_get_oapg(
        self,
...
class ListEngineEnginesNameVersionGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def list_engine_engines_name_version_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def list_engine_engines_name_version_get(
        ...
        return self._list_engine_engines_name_version_get_oapg(
