...
# body param
SchemaForRequestBodyApplicationJson = CreateTag
...
SchemaFor201ResponseBodyApplicationJson = Tag
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_tag_tags_post_oapg(
        self,
...
class CreateTagTagsPost(BaseApi):
    ...
    def create_tag_tags_post(
        ...
        return self._create_tag_tags_post_oapg(
            body=body,
