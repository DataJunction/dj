...
def test_parsing_ansi_tpcds_queries(query_file, request, monkeypatch):
    """
    Test parsing ANSI SQL TPCDS queries into DJ ASTs
    """
...
def test_parsing_sparksql_tpcds_queries(query_file, request, monkeypatch):
    """
