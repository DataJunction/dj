...
class NodeOutput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current", "created_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current", "created_at", ], str]):
