...
Welcome to ``datajunction`` contributor's guide.
...
If you experience bugs or general issues with ``datajunction``, please have a look
...
You can help improve ``datajunction`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``datajunction`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``datajunction``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/datajunction.git
    cd datajunction
...
#. Install |pre-commit|_::
   ...
   ``datajunction`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/datajunction
.. _issue tracker: https://github.com/<USERNAME>/datajunction/issues
.. <-- end -->
