            ...
            <div className="config-form-body">
              ...
              <div className="config-form-row">
                ...
                {configForm.scheduleType === 'auto' && (
                  <span className="config-form-hint">
                    Based on {configForm._granularity?.toLowerCase() || 'daily'}{' '}
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    if (configForm.scheduleType === 'auto') {
                      finalSchedule =
                        configForm._recommendedSchedule?.cron || '0 6 * * *';
                          ...
                          {existingPreagg.workflow_urls?.length > 0 && (
                            <div className="config-row">
                              ...
                              <div className="workflow-links">
                                {existingPreagg.workflow_urls.map(
                                  (url, idx) => (
                                    <a
                                      key={idx}
                                      href={url}
                                    ...
                                    onClick={async e => {
                                      ...
                                      try {
                                        ...
                                        if (result?.workflow_url) {
                                          setToastMessage(
                                            `Workflow created: ${result.workflow_url}`,
                                          );
                                          setTimeout(
