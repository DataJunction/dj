...
QUERY_DATA_MAPPINGS: Dict[str, Union[DJException, QueryWithResults]] = {
    ...
    "LEFTJOIN(SELECTdefault_DOT_repair_orders.repair_order_id,\tdefault_DOT_repair"
    ...
    "_order.repair_order_idLEFTJOIN(SELECTdefault_DOT_hard_hats.hard_hat_id,\tdefault"
    ...
    "FROMroads.repair_order_detailsASdefault_DOT_repair_order_detailsLEFTJOIN(SELECT"
    ...
    "JOIN(SELECTdefault_DOT_hard_hats.hard_hat_id,\tdefault_DOT_hard_hats.city,\t"
