...
class Node(ClientEntity):  # pylint: disable=protected-access
    ...
    def add_reference_dimension_link(
        ...
        """
        Adds a reference dimension link from the node's `node_column` to
        the dimension node's `dimension_column`.
        """
    ...
    def remove_reference_dimension_link(
        ...
        """
        Remove a reference dimension link from the node's `node_column`.
        """
