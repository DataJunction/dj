...
class SqlBaseParserVisitor(ParseTreeVisitor):
    ...
    def visitSingleTableIdentifier(
        self, ctx: SqlBaseParser.SingleTableIdentifierContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#singleMultipartIdentifier.
    def visitSingleMultipartIdentifier(
    ...
    def visitSingleFunctionIdentifier(
        self, ctx: SqlBaseParser.SingleFunctionIdentifierContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitSetNamespaceProperties(
        self, ctx: SqlBaseParser.SetNamespacePropertiesContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitAlterTableAlterColumn(
        self, ctx: SqlBaseParser.AlterTableAlterColumnContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitSetQuotedConfiguration(
        self, ctx: SqlBaseParser.SetQuotedConfigurationContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitResetQuotedConfiguration(
        self, ctx: SqlBaseParser.ResetQuotedConfigurationContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitUnsupportedHiveNativeCommands(
        self, ctx: SqlBaseParser.UnsupportedHiveNativeCommandsContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitInsertIntoReplaceWhere(
        self, ctx: SqlBaseParser.InsertIntoReplaceWhereContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#insertOverwriteHiveDir.
    def visitInsertOverwriteHiveDir(
        self, ctx: SqlBaseParser.InsertOverwriteHiveDirContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitPartitionSpecLocation(
        self, ctx: SqlBaseParser.PartitionSpecLocationContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitTransformQuerySpecification(
        self, ctx: SqlBaseParser.TransformQuerySpecificationContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#regularQuerySpecification.
    def visitRegularQuerySpecification(
        self, ctx: SqlBaseParser.RegularQuerySpecificationContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitNotMatchedBySourceClause(
        self, ctx: SqlBaseParser.NotMatchedBySourceClauseContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitNotMatchedBySourceAction(
        self, ctx: SqlBaseParser.NotMatchedBySourceActionContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitUnpivotSingleValueColumnClause(
        self, ctx: SqlBaseParser.UnpivotSingleValueColumnClauseContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#unpivotMultiValueColumnClause.
    def visitUnpivotMultiValueColumnClause(
    ...
    def visitUnpivotColumnAndAlias(
        self, ctx: SqlBaseParser.UnpivotColumnAndAliasContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitOrderedIdentifierList(
        self, ctx: SqlBaseParser.OrderedIdentifierListContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitIdentifierCommentList(
        self, ctx: SqlBaseParser.IdentifierCommentListContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitMultipartIdentifierList(
        self, ctx: SqlBaseParser.MultipartIdentifierListContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitMultipartIdentifierProperty(
        self, ctx: SqlBaseParser.MultipartIdentifierPropertyContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitErrorCapturingMultiUnitsInterval(
        self, ctx: SqlBaseParser.ErrorCapturingMultiUnitsIntervalContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitErrorCapturingUnitToUnitInterval(
        self, ctx: SqlBaseParser.ErrorCapturingUnitToUnitIntervalContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitYearMonthIntervalDataType(
        self, ctx: SqlBaseParser.YearMonthIntervalDataTypeContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#dayTimeIntervalDataType.
    def visitDayTimeIntervalDataType(
        self, ctx: SqlBaseParser.DayTimeIntervalDataTypeContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitQualifiedColTypeWithPositionList(
        self, ctx: SqlBaseParser.QualifiedColTypeWithPositionListContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#qualifiedColTypeWithPosition.
    def visitQualifiedColTypeWithPosition(
        self, ctx: SqlBaseParser.QualifiedColTypeWithPositionContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#colDefinitionDescriptorWithPosition.
    def visitColDefinitionDescriptorWithPosition(
    ...
    def visitCreateOrReplaceTableColTypeList(
        self, ctx: SqlBaseParser.CreateOrReplaceTableColTypeListContext,
    ):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by SqlBaseParser#createOrReplaceTableColType.
    def visitCreateOrReplaceTableColType(
        self, ctx: SqlBaseParser.CreateOrReplaceTableColTypeContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitErrorCapturingIdentifier(
        self, ctx: SqlBaseParser.ErrorCapturingIdentifierContext,
    ):
        return self.visitChildren(ctx)
    ...
    def visitQuotedIdentifierAlternative(
        self, ctx: SqlBaseParser.QuotedIdentifierAlternativeContext,
    ):
        return self.visitChildren(ctx)
