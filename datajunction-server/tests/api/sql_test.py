...
async def test_sql2(
    ...
    assert assert_query_strings_equal(
        response["sql"],
    ...
    assert assert_query_strings_equal(query_request[0].query, response["sql"])
...
#         ),
        ...
        (
            ...
            FROM default_DOT_repair_orders_fact INNER JOIN default_DOT_hard_hat
...
@pytest.mark.asyncio
async def test_get_sql_for_metrics(module__client_with_examples: AsyncClient):
    """
    Test getting sql for multiple metrics.
    """
