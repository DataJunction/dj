...
def test_common_dimensions(
    ...
    assert sorted(
        response.json(),
        key=lambda dim: (dim["name"], dim["link"]),
    ) == sorted(
        [
            {
                "link": "hire_date",
            ...
            {"link": "hire_date", "name": "default.date_dim.day", "type": "int"},
            {"link": "birth_date", "name": "default.date_dim.day", "type": "int"},
            {"link": "birth_date", "name": "default.date_dim.month", "type": "int"},
            {"link": "hire_date", "name": "default.date_dim.month", "type": "int"},
            {"link": "hire_date", "name": "default.date_dim.year", "type": "int"},
            {"link": "birth_date", "name": "default.date_dim.year", "type": "int"},
            {
...
def test_get_dimensions(client_with_examples: TestClient):
    ...
    assert data["dimensions"] == [
        ...
        {"link": "dispatcher_id", "name": "default.dispatcher.phone", "type": "string"},
        {"link": "hard_hat_id", "name": "default.hard_hat.address", "type": "string"},
        {
            "link": "hard_hat_id",
            "name": "default.hard_hat.birth_date",
            "type": "timestamp",
        },
        {"link": "hard_hat_id", "name": "default.hard_hat.city", "type": "string"},
        {
            "link": "hard_hat_id",
            "name": "default.hard_hat.contractor_id",
            "type": "int",
        },
        {"link": "hard_hat_id", "name": "default.hard_hat.country", "type": "string"},
        {
            "link": "hard_hat_id",
            "name": "default.hard_hat.first_name",
            "type": "string",
        },
        {"link": "hard_hat_id", "name": "default.hard_hat.hard_hat_id", "type": "int"},
        {
            "link": "hard_hat_id",
            "name": "default.hard_hat.hire_date",
            "type": "timestamp",
        },
        {"link": "hard_hat_id", "name": "default.hard_hat.last_name", "type": "string"},
        {"link": "hard_hat_id", "name": "default.hard_hat.manager", "type": "int"},
        {
            "link": "hard_hat_id",
            "name": "default.hard_hat.postal_code",
            "type": "string",
        },
        {"link": "hard_hat_id", "name": "default.hard_hat.state", "type": "string"},
        {"link": "hard_hat_id", "name": "default.hard_hat.title", "type": "string"},
        {
            "link": "municipality_id",
            "name": "default.municipality_dim.contact_name",
            "type": "string",
        ...
        {"link": "state", "name": "default.us_state.state_id", "type": "int"},
        {"link": "state", "name": "default.us_state.state_name", "type": "string"},
        {"link": "state", "name": "default.us_state.state_region", "type": "int"},
        {
            "link": "state",
            "name": "default.us_state.state_region_description",
            "type": "string",
        },
        {"link": "state", "name": "default.us_state.state_short", "type": "string"},
    ]
...
def test_get_multi_link_dimensions(
    ...
    assert response.json()["dimensions"] == [
        {"link": "birth_date", "name": "default.date_dim.dateint", "type": "timestamp"},
        {"link": "hire_date", "name": "default.date_dim.dateint", "type": "timestamp"},
        {"link": "birth_date", "name": "default.date_dim.day", "type": "int"},
        {"link": "hire_date", "name": "default.date_dim.day", "type": "int"},
        {"link": "birth_date", "name": "default.date_dim.month", "type": "int"},
        {"link": "hire_date", "name": "default.date_dim.month", "type": "int"},
        ...
        {"link": "", "name": "default.repair_orders.dispatcher_id", "type": "int"},
        {"link": "", "name": "default.repair_orders.hard_hat_id", "type": "int"},
        {"link": "", "name": "default.repair_orders.municipality_id", "type": "string"},
        {"link": "state", "name": "default.us_state.state_id", "type": "int"},
        {"link": "state", "name": "default.us_state.state_name", "type": "string"},
        {"link": "state", "name": "default.us_state.state_region", "type": "int"},
        {
