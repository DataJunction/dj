...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            SELECT
              default_DOT_repair_orders_fact.dispatcher_id AS
                default_DOT_dispatcher_DOT_dispatcher_id,
              default_DOT_repair_orders_fact.discount AS
                default_DOT_repair_orders_fact_DOT_discount,
              default_DOT_repair_orders_fact.price AS
        ...
        (
            ...
            SELECT
              default_DOT_repair_orders_fact.total_repair_cost AS
                default_DOT_repair_orders_fact_DOT_total_repair_cost,
              default_DOT_repair_orders_fact.time_to_dispatch AS
                default_DOT_repair_orders_fact_DOT_time_to_dispatch,
              default_DOT_us_state.state_name AS
                default_DOT_us_state_DOT_state_name,
              default_DOT_dispatcher.company_name AS
                default_DOT_dispatcher_DOT_company_name,
              default_DOT_hard_hat.last_name AS
