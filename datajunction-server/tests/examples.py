...
QUERY_DATA_MAPPINGS = {
    (
        "WITHm0_default_DOT_discounted_orders_rateAS(SELECTdefault_DOT_dispatcher.company_name,\t"
        "CAST(sum(if(default_DOT_repair_order_details.discount>0.0,1,0))ASDOUBLE)/count(*)AS"
        "default_DOT_discounted_orders_rateFROMroads.repair_order_detailsAS"
        "default_DOT_repair_order_detailsLEFTOUTERJOIN(SELECTdefault_DOT_repair_orders."
        ...
        ".repair_order_id=default_DOT_repair_order.repair_order_idLEFTOUTERJOIN(SELECTdefault_"
        "DOT_dispatchers.company_name,\tdefault_DOT_dispatchers.dispatcher_idFROMroads.dispatchers"
        "ASdefault_DOT_dispatchers)ASdefault_DOT_dispatcherONdefault_DOT_repair_order."
        "dispatcher_id=default_DOT_dispatcher.dispatcher_idGROUPBYdefault_DOT_dispatcher."
        "company_name),m1_default_DOT_avg_repair_priceAS(SELECTdefault_DOT_dispatcher.company_name,"
        "\tavg(default_DOT_repair_order_details.price)ASdefault_DOT_avg_repair_priceFROM"
        "roads.repair_order_detailsASdefault_DOT_repair_order_detailsLEFTOUTERJOIN(SELECT"
        "default_DOT_repair_orders.dispatcher_id,\tdefault_DOT_repair_orders.hard_hat_id,"
        "\tdefault_DOT_repair_orders.municipality_id,\tdefault_DOT_repair_orders.repair_order"
        "_idFROMroads.repair_ordersASdefault_DOT_repair_orders)ASdefault_DOT_repair_orderON"
        "default_DOT_repair_order_details.repair_order_id=default_DOT_repair_order.repair_"
        "order_idLEFTOUTERJOIN(SELECTdefault_DOT_dispatchers.company_name,\t"
        "default_DOT_dispatchers.dispatcher_idFROMroads.dispatchersASdefault_DOT_dispatchers)"
        "ASdefault_DOT_dispatcherONdefault_DOT_repair_order.dispatcher_id=default_DOT_dispatcher"
        ".dispatcher_idGROUPBYdefault_DOT_dispatcher.company_name)SELECTm0_default_DOT_discounted"
        "_orders_rate.default_DOT_discounted_orders_rate,\tm1_default_DOT_avg_repair_price.default_"
        "DOT_avg_repair_price,\tCOALESCE(m0_default_DOT_discounted_orders_rate.company_name,"
        "m1_default_DOT_avg_repair_price.company_name)company_nameFROMm0_default_DOT_discounted_"
        "orders_rateFULLOUTERJOINm1_default_DOT_avg_repair_priceONm0_default_DOT_discounted_orders_"
        "rate.company_name=m1_default_DOT_avg_repair_price.company_nameLIMIT10"
    )
    .strip()
    .replace('"', "")
    .replace("\n", "")
