...
class SqlBaseParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SqlBaseParser#percentile.
    def enterPercentile(self, ctx:SqlBaseParser.PercentileContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#percentile.
    def exitPercentile(self, ctx:SqlBaseParser.PercentileContext):
        pass
    ...
    # Enter a parse tree produced by SqlBaseParser#parameterLiteral.
    def enterParameterLiteral(self, ctx:SqlBaseParser.ParameterLiteralContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#parameterLiteral.
    def exitParameterLiteral(self, ctx:SqlBaseParser.ParameterLiteralContext):
        pass
    ...
    def enterCreateOrReplaceTableColTypeList(self, ctx:SqlBaseParser.CreateOrReplaceTableColTypeListContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#createOrReplaceTableColTypeList.
    def exitCreateOrReplaceTableColTypeList(self, ctx:SqlBaseParser.CreateOrReplaceTableColTypeListContext):
        pass


    # Enter a parse tree produced by SqlBaseParser#createOrReplaceTableColType.
    def enterCreateOrReplaceTableColType(self, ctx:SqlBaseParser.CreateOrReplaceTableColTypeContext):
        pass

    # Exit a parse tree produced by SqlBaseParser#createOrReplaceTableColType.
    def exitCreateOrReplaceTableColType(self, ctx:SqlBaseParser.CreateOrReplaceTableColTypeContext):
        pass
