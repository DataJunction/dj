...
class HttpQueryServiceClient(BaseQueryServiceClient):
    ...
    def materialize_preagg(
        ...
        """Set up a scheduled pre-aggregation materialization via HTTP query service."""
    ...
    def create_preagg_workflow(
        ...
        """Create a scheduled workflow for a pre-aggregation via HTTP query service."""
        return self._client.create_preagg_workflow(
