...
class DeploymentImpactResponse(BaseModel):
    """Full response for deployment impact analysis (dry run and wet run)."""

    namespace: str

    # Present on wet-run responses; None for dry-run previews
    uuid: str | None = None
    status: str | None = None  # "pending" | "running" | "success" | "failed"
