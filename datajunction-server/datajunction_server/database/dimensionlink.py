...
class DimensionLink(Base):
    ...
    def to_spec(self):
        ...
        return DimensionJoinLinkSpec(
            ...
            # join_cardinality=self.join_cardinality.name
            # if self.join_cardinality
            # else JoinCardinality.MANY_TO_ONE.name,
            # materialization_conf=self.materialization_conf or {},
        )
