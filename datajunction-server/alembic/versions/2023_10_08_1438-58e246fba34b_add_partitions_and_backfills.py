...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['column_id'], ['column.id'], name=op.f('fk_partition_column_id_column')),
    ...
    with op.batch_alter_table('column', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_column_partition_id_partition'), 'partition', ['partition_id'], ['id'])

    with op.batch_alter_table('materialization', schema=None) as batch_op:
        batch_op.add_column(sa.Column('id', sa.Integer(), nullable=True))
        batch_op.create_unique_constraint('node_revision_engine_uniq', ['name', 'node_revision_id', 'engine_id'])
...
def downgrade():
    ...
    with op.batch_alter_table('column', schema=None) as batch_op:
        batch_op.drop_constraint(batch_op.f('fk_column_partition_id_partition'), type_='foreignkey')
