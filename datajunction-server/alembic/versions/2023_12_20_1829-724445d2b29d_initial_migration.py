...
def upgrade():
    ...
    sa.UniqueConstraint('namespace', 'name', name=op.f('uq_attributetype_namespace'))
    )
    op.create_table('availabilitystate',
    ...
    sa.Column('display_name', sa.String(), nullable=True),
    sa.Column('additive', sa.Enum('ADDITIVE', 'NON_ADDITIVE', 'SEMI_ADDITIVE', name='aggregationrule'), nullable=True),
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['dimension_id'], ['node.id'], name=op.f('fk_column_dimension_id_node')),
    sa.ForeignKeyConstraint(['measure_id'], ['measures.id'], name=op.f('fk_column_measure_id_measures')),
    sa.ForeignKeyConstraint(['partition_id'], ['partition.id'], name=op.f('fk_column_partition_id_partition')),
    ...
    sa.Column('dialect', sa.Enum('SPARK', 'TRINO', 'DRUID', name='dialect'), nullable=True),
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    op.create_table('metricmetadata',
    sa.Column('direction', sa.Enum('HIGHER_IS_BETTER', 'LOWER_IS_BETTER', 'NEUTRAL', name='metricdirection'), nullable=True),
    sa.Column('unit', sa.Enum('UNKNOWN', 'UNITLESS', 'PERCENTAGE', 'PROPORTION', 'DOLLAR', 'SECOND', 'MINUTE', 'HOUR', 'DAY', 'WEEK', 'MONTH', 'YEAR', name='metricunit'), nullable=True),
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_metricmetadata'))
    )
    op.create_table('missingparent',
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_missingparent'))
    )
    op.create_table('nodenamespace',
    sa.Column('deactivated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('namespace', sa.String(), nullable=False),
    ...
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('oauth_provider', sa.Enum('BASIC', 'GITHUB', 'GOOGLE', name='oauthprovider'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['catalog_id'], ['catalog.id'], name=op.f('fk_catalogengines_catalog_id_catalog')),
    sa.ForeignKeyConstraint(['engine_id'], ['engine.id'], name=op.f('fk_catalogengines_engine_id_engine')),
    sa.PrimaryKeyConstraint('catalog_id', 'engine_id', name=op.f('pk_catalogengines'))
    )
    op.create_table('columnattribute',
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('attribute_type_id', sa.BigInteger(), nullable=True),
    sa.Column('column_id', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['attribute_type_id'], ['attributetype.id'], name=op.f('fk_columnattribute_attribute_type_id_attributetype')),
    sa.ForeignKeyConstraint(['column_id'], ['column.id'], name=op.f('fk_columnattribute_column_id_column')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_columnattribute')),
    sa.UniqueConstraint('attribute_type_id', 'column_id', name=op.f('uq_columnattribute_attribute_type_id'))
    )
    op.create_table('noderevision',
    sa.Column('name', sa.String(), nullable=True),
    sa.Column('display_name', sa.String(), nullable=True),
    sa.Column('type', sa.Enum('SOURCE', 'TRANSFORM', 'METRIC', 'DIMENSION', 'CUBE', name='nodetype'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.ForeignKeyConstraint(['catalog_id'], ['catalog.id'], name=op.f('fk_noderevision_catalog_id_catalog')),
    sa.ForeignKeyConstraint(['metric_metadata_id'], ['metricmetadata.id'], name=op.f('fk_noderevision_metric_metadata_id_metricmetadata')),
    sa.ForeignKeyConstraint(['node_id'], ['node.id'], name=op.f('fk_noderevision_node_id_node')),
    ...
    sa.ForeignKeyConstraint(['database_id'], ['database.id'], name=op.f('fk_table_database_id_database')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_table'))
    )
    op.create_table('tagnoderelationship',
    sa.Column('tag_id', sa.BigInteger(), nullable=False),
    sa.Column('node_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['node_id'], ['node.id'], name=op.f('fk_tagnoderelationship_node_id_node')),
    sa.ForeignKeyConstraint(['tag_id'], ['tag.id'], name=op.f('fk_tagnoderelationship_tag_id_tag')),
    sa.PrimaryKeyConstraint('tag_id', 'node_id', name=op.f('pk_tagnoderelationship'))
    )
    op.create_table('cube',
    sa.Column('cube_id', sa.BigInteger(), nullable=False),
    sa.Column('cube_element_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['cube_element_id'], ['column.id'], name=op.f('fk_cube_cube_element_id_column')),
    sa.ForeignKeyConstraint(['cube_id'], ['noderevision.id'], name=op.f('fk_cube_cube_id_noderevision')),
    sa.PrimaryKeyConstraint('cube_id', 'cube_element_id', name=op.f('pk_cube'))
    )
    op.create_table('materialization',
    sa.Column('strategy', sa.Enum('FULL', 'SNAPSHOT', 'SNAPSHOT_PARTITION', 'INCREMENTAL_TIME', 'VIEW', name='materializationstrategy'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['node_revision_id'], ['noderevision.id'], name=op.f('fk_materialization_node_revision_id_noderevision')),
    ...
    op.create_table('metric_required_dimensions',
    sa.Column('metric_id', sa.BigInteger(), nullable=False),
    sa.Column('bound_dimension_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['bound_dimension_id'], ['column.id'], name=op.f('fk_metric_required_dimensions_bound_dimension_id_column')),
    sa.ForeignKeyConstraint(['metric_id'], ['noderevision.id'], name=op.f('fk_metric_required_dimensions_metric_id_noderevision')),
    sa.PrimaryKeyConstraint('metric_id', 'bound_dimension_id', name=op.f('pk_metric_required_dimensions'))
    )
    op.create_table('nodeavailabilitystate',
    sa.Column('availability_id', sa.BigInteger(), nullable=False),
    sa.Column('node_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['availability_id'], ['availabilitystate.id'], name=op.f('fk_nodeavailabilitystate_availability_id_availabilitystate')),
    sa.ForeignKeyConstraint(['node_id'], ['noderevision.id'], name=op.f('fk_nodeavailabilitystate_node_id_noderevision')),
    sa.PrimaryKeyConstraint('availability_id', 'node_id', name=op.f('pk_nodeavailabilitystate'))
    )
    op.create_table('nodecolumns',
    sa.Column('node_id', sa.BigInteger(), nullable=False),
    sa.Column('column_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['column_id'], ['column.id'], name=op.f('fk_nodecolumns_column_id_column')),
    sa.ForeignKeyConstraint(['node_id'], ['noderevision.id'], name=op.f('fk_nodecolumns_node_id_noderevision')),
    sa.PrimaryKeyConstraint('node_id', 'column_id', name=op.f('pk_nodecolumns'))
    )
    op.create_table('nodemissingparents',
    sa.Column('missing_parent_id', sa.BigInteger(), nullable=False),
    sa.Column('referencing_node_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['missing_parent_id'], ['missingparent.id'], name=op.f('fk_nodemissingparents_missing_parent_id_missingparent')),
    sa.ForeignKeyConstraint(['referencing_node_id'], ['noderevision.id'], name=op.f('fk_nodemissingparents_referencing_node_id_noderevision')),
    sa.PrimaryKeyConstraint('missing_parent_id', 'referencing_node_id', name=op.f('pk_nodemissingparents'))
    )
    op.create_table('noderelationship',
    ...
    sa.ForeignKeyConstraint(['child_id'], ['noderevision.id'], name=op.f('fk_noderelationship_child_id_noderevision')),
    sa.ForeignKeyConstraint(['parent_id'], ['node.id'], name=op.f('fk_noderelationship_parent_id_node')),
    sa.PrimaryKeyConstraint('parent_id', 'child_id', name=op.f('pk_noderelationship'))
    )
    op.create_table('tablecolumns',
    sa.Column('table_id', sa.BigInteger(), nullable=False),
    sa.Column('column_id', sa.BigInteger(), nullable=False),
    sa.ForeignKeyConstraint(['column_id'], ['column.id'], name=op.f('fk_tablecolumns_column_id_column')),
    sa.ForeignKeyConstraint(['table_id'], ['table.id'], name=op.f('fk_tablecolumns_table_id_table')),
    ...
    sa.ForeignKeyConstraint(['materialization_id'], ['materialization.id'], name=op.f('fk_backfill_materialization_id_materialization')),
